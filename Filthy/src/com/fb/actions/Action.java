...
public class Action {
	...
	public void complete() {
		...
		System.out.println("there are <" + postActionChanges.size() + "> changes to make.");
		...
		while(changeIter.hasNext()){
			...
			if(change instanceof ObjectAttributeChange) {
				GameObject objectToChange = gameObjects.get(((ObjectAttributeChange)change).getObjectId());
				String attribute = ((ObjectAttributeChange)change).getAttribute();
				String value = ((ObjectAttributeChange)change).getValue();
				System.out.println("Changing object " + objectToChange);
				ObjectAttributeChange.modifyAttributeOnObject(objectToChange, attribute, value);
			}
		}
	...
	public String toString() {
		...
		while(objectIter.hasNext()){
			...
			sb.append("Attached object: " + gameObject + ".").append(System.getProperty("line.separator"));
		}
		return sb.toString();
	}
}
