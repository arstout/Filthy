...
public class Main {
	...
	public static void main(String[] args) {
		...
		// add attributes to game objects
		bobsSouth40.addAttribute("status", "uncultivated");
		bobsSouth40.addAttribute("scope", "world");

		// add types to game objects
		List<String> bobsSouth40Types = new ArrayList<String>();
		bobsSouth40Types.add("field");
		bobsSouth40Types.add("location");
		gameObjects.add(bobsSouth40, bobsSouth40Types);
		...
		ObjectExistenceRequirement req = new ObjectExistenceRequirement("1",
				"field");
		...
		cultivateField.addPostActionChange(new ObjectAttributeChange("1",
				"status", "cultivated"));
		...
		plantField.addPostActionChange(new ObjectAttributeChange("1", "status",
				"planted"));
		...
		waterField.addPostActionChange(new ObjectAttributeChange("1", "status",
				"watered"));
		...
		occupations.put(
				"Simple Farmer",
				new Occupation("Farmer", behaviorTrees
						.get("simple_farmer_tree")));

		// set up people
		people.add(new Person("Farmer John", 20, occupations
				.get("Simple Farmer")));
